    ...
    return (
        <>
            <div className=" py-5 px-5 md:px-15 lg:px-35">
                ...
                <div className="flex flex-col md:flex-row items-center  justify-center md:justify-between  px-5  md: px-10 mb-5 bg-emerald-50 py-5">
                    <select value={filteredSecteur} onChange={(e) => setFilteredSecteur(e.target.value)}
                        className="border border-emerald-600 rounded-lg px-2 py-1"   >
